...
const attendanceAlertTypeLabels: Record<AttendanceAlertType, string> = {
  ...
  MULTI_DEVICE_ATTEMPT: "Çoklu Cihaz Denemesi",
  SUSPICIOUS_TOKEN_REUSE: "Şüpheli QR/Token Kullanımı",
  TOKEN_REPLACED_BY_NEW_QR: "Eski QR Token İptal Edildi",
  DEVICE_REGISTERED: "Yeni Cihaz Kaydedildi",
